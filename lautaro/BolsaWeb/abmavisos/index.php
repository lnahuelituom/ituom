...
/*if (isset($_POST['id'])) //Si llego un Nickname via el formulario lo grabamos en la Sesion
{
    $_SESSION['id'] = $_POST['_id']; //Nickname Grabado
}
if ( $_SESSION['id']) //Si hay un nickname en la sesion actual, creamos una variable que será mostrada
{
...
<tr>
	<td>Empresa_id</td>
	<td><input type="text" name="empresa_id" value = "<?php print $grabado ?>"></td>
</tr>
<tr>
	<td>Descripcion</td>
