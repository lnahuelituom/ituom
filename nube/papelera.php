...
<br>
<br><p><a href="portafolio.php"> Tu Portafolio</a>
<br>
<br><p><a href="papelera.php"> Papelera </a><p>
<br>
...
<br>
    ...
    <OPTION VALUE="Descargar" target="secciones">Descargar</OPTION> 
    <OPTION VALUE="Eliminar" target="secciones">Eliminar</OPTION>
    <OPTION VALUE="Marcar Todos" target="secciones">Marcar Todos</OPTION> 
        </SELECT> 
     		       
        <iframe src="mostrar.archivos.php" width="950" height="350" marginheight="0" marginwidth="0" noresize scrolling="Si" frameborder="0" name= "secciones"> 
            </iframe>
